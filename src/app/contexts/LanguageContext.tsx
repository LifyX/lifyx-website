...
const translations: Record<Language, Record<string, string>> = {
  ...
  fr: {
    ...
    'footer.copyright': '© 2026 LifyX. Construit avec précision.',
    'footer.language': 'Langue',
    'footer.cta.title': 'Démarrez votre projet aujourd\'hui',
    'footer.cta.description': 'Prêt à améliorer votre présence numérique? Construisons quelque chose d\'exceptionnel ensemble.',
  ...
  es: {
    ...
    'footer.copyright': '© 2026 LifyX. Construido con precisión.',
    'footer.language': 'Idioma',
    'footer.cta.title': 'Comience su proyecto hoy',
    'footer.cta.description': '¿Listo para mejorar su presencia digital? Construyamos algo excepcional juntos.',
