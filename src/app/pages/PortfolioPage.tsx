            ...
            <div className="group grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12 items-center">
              ...
              <div className="lg:col-span-8 overflow-hidden rounded-sm relative aspect-[16/9] lg:aspect-[16/10]">
                ...
                {projects[0].comingSoon && (
                  <div className="absolute top-4 right-4 bg-primary/90 backdrop-blur-sm text-background px-4 py-2 rounded-full text-xs font-bold uppercase tracking-wider">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <img 
                    ...
                    className="w-48 md:w-60 lg:w-72 h-auto drop-shadow-2xl"
                  />
                </div>
              </div>
              ...
              <div className="lg:col-span-4 flex flex-col h-full justify-center">
                ...
                <div className="flex items-center gap-8">
                  <a href={projects[0].link} className="flex items-center gap-2 text-foreground hover:text-primary transition-colors uppercase tracking-wider text-xs font-bold group/link">
